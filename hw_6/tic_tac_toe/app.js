...
let ticTacToe = {
     ...
     * объекте event был по ячейки и ячейка куда был произведен клик был по пустой ячейке. 
    */
    ...
    /**
     * Проверка что клик был по ячейки
     * @param {Event} event 
     * @param {HTMLElement} event.target
     * @returns {boolean} Вернет true, если клик был по ячейки, иначе false.
     */
    isClickByCell(event) {
     ...
     * @returns {boolean} Вернет true, если игра выиграна, инача false.
     */
    hasWon() {
     ...
     * @returns {boolean} Вернет true, если линия выиграна, инача false.
     */
    isLineWon(a, b, c) {
